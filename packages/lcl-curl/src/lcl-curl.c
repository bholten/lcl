...
int fn_name(lcl_interp *interp, int argc, lcl_value **argv, lcl_value **out) { \
  struct curl_context *ctx; \
  const char *val; \
  (void)interp; (void)out; \
  if (argc < 2) return LCL_RC_ERR; \
  if (lcl_opaque_get(argv[0], CURL_CONTEXT_TYPE, (void**)&ctx) != LCL_OK) return LCL_RC_ERR; \
  val = lcl_value_to_string(argv[1]); \
  return (curl_easy_setopt(ctx->curl, curl_opt, val) == CURLE_OK) ? LCL_RC_OK : LCL_RC_ERR; \
}
...
CURL_LONG_OPTION(c_curl_set_option_connection_timeout_ms, CURLOPT_CONNECTTIMEOUT_MS)
...
CURL_LONG_OPTION(c_curl_set_option_proxy_ssl_verify_peer, CURLOPT_PROXY_SSL_VERIFYPEER)
CURL_LONG_OPTION(c_curl_set_option_proxy_ssl_verify_host, CURLOPT_PROXY_SSL_VERIFYHOST)
...
CURL_LONG_OPTION(c_curl_set_option_expect_100_timeout_ms, CURLOPT_EXPECT_100_TIMEOUT_MS)
CURL_LONG_OPTION(c_curl_set_option_max_recv_speed_large, CURLOPT_MAX_RECV_SPEED_LARGE)
CURL_LONG_OPTION(c_curl_set_option_max_send_speed_large, CURLOPT_MAX_SEND_SPEED_LARGE)
...
int fn_name(lcl_interp *interp, int argc, lcl_value **argv, lcl_value **out) { \
  ...
  if (lcl_opaque_get(argv[0], CURL_CONTEXT_TYPE, (void**)&ctx) != LCL_OK) return LCL_RC_ERR; \
  if (curl_easy_getinfo(ctx->curl, curl_info, &val) != CURLE_OK) return LCL_RC_ERR; \
  *out = lcl_int_new(val); \
  return LCL_RC_OK; \
}
...
void lcl_register_curl(lcl_interp *interp) {
  ...
  lcl_ns_def(curl_ns, "set_user_agent", lcl_c_proc_new("curl::set_user_agent", c_curl_set_option_user_agent));

  /* Timeouts and connection settings */
  lcl_ns_def(curl_ns, "set_timeout_ms",            lcl_c_proc_new("curl::set_timeout_ms", c_curl_set_option_timeout_ms));
  ...
  lcl_ns_def(curl_ns, "set_expect_100_timeout_ms", lcl_c_proc_new("curl::set_expect_100_timeout_ms", c_curl_set_option_expect_100_timeout_ms));
  ...
  /* Redirects */
  lcl_ns_def(curl_ns, "set_follow_location", lcl_c_proc_new("curl::set_follow_location", c_curl_set_option_follow_location));
  lcl_ns_def(curl_ns, "set_max_redirects",   lcl_c_proc_new("curl::set_max_redirects", c_curl_set_option_max_redirects));
  lcl_ns_def(curl_ns, "set_post_redirect",   lcl_c_proc_new("curl::set_post_redirect", c_curl_set_option_post_redirect));

  /* Authentication */
  lcl_ns_def(curl_ns, "set_httpauth",       lcl_c_proc_new("curl::set_httpauth", c_curl_set_option_httpauth));
  lcl_ns_def(curl_ns, "set_username",       lcl_c_proc_new("curl::set_username", c_curl_set_option_username));
  lcl_ns_def(curl_ns, "set_password",       lcl_c_proc_new("curl::set_password", c_curl_set_option_password));
  lcl_ns_def(curl_ns, "set_xoauth2_bearer", lcl_c_proc_new("curl::set_xoauth2_bearer", c_curl_set_option_xoauth2_bearer));

  /* TLS/SSL */
  lcl_ns_def(curl_ns, "set_ssl_verify_peer", lcl_c_proc_new("curl::set_ssl_verify_peer", c_curl_set_option_ssl_verify_peer));
  lcl_ns_def(curl_ns, "set_ssl_verify_host", lcl_c_proc_new("curl::set_ssl_verify_host", c_curl_set_option_ssl_verify_host));
  lcl_ns_def(curl_ns, "set_ca_info",         lcl_c_proc_new("curl::set_ca_info", c_curl_set_option_ca_info));
  lcl_ns_def(curl_ns, "set_ca_path",         lcl_c_proc_new("curl::set_ca_path", c_curl_set_option_ca_path));
  lcl_ns_def(curl_ns, "set_ssl_cert",        lcl_c_proc_new("curl::set_ssl_cert", c_curl_set_option_ssl_cert));
  lcl_ns_def(curl_ns, "set_ssl_cert_type",   lcl_c_proc_new("curl::set_ssl_cert_type", c_curl_set_option_ssl_cert_type));
  lcl_ns_def(curl_ns, "set_ssl_key",         lcl_c_proc_new("curl::set_ssl_key", c_curl_set_option_ssl_key));
  lcl_ns_def(curl_ns, "set_ssl_key_type",    lcl_c_proc_new("curl::set_ssl_key_type", c_curl_set_option_ssl_key_type));
  lcl_ns_def(curl_ns, "set_key_password",    lcl_c_proc_new("curl::set_key_password", c_curl_set_option_key_password));
  lcl_ns_def(curl_ns, "set_ssl_version",     lcl_c_proc_new("curl::set_ssl_version", c_curl_set_option_ssl_version));
  lcl_ns_def(curl_ns, "set_ssl_cipher_list", lcl_c_proc_new("curl::set_ssl_cipher_list", c_curl_set_option_ssl_cipher_list));
  lcl_ns_def(curl_ns, "set_tls13_ciphers",   lcl_c_proc_new("curl::set_tls13_ciphers", c_curl_set_option_tls13_ciphers));

  /* Proxy */
  lcl_ns_def(curl_ns, "set_proxy",                 lcl_c_proc_new("curl::set_proxy", c_curl_set_option_proxy));
  lcl_ns_def(curl_ns, "set_proxy_port",            lcl_c_proc_new("curl::set_proxy_port", c_curl_set_option_proxy_port));
  lcl_ns_def(curl_ns, "set_proxy_type",            lcl_c_proc_new("curl::set_proxy_type", c_curl_set_option_proxy_type));
  lcl_ns_def(curl_ns, "set_proxy_username",        lcl_c_proc_new("curl::set_proxy_username", c_curl_set_option_proxy_username));
  lcl_ns_def(curl_ns, "set_proxy_password",        lcl_c_proc_new("curl::set_proxy_password", c_curl_set_option_proxy_password));
  lcl_ns_def(curl_ns, "set_no_proxy",              lcl_c_proc_new("curl::set_no_proxy", c_curl_set_option_no_proxy));
  lcl_ns_def(curl_ns, "set_proxy_ssl_verify_peer", lcl_c_proc_new("curl::set_proxy_ssl_verify_peer", c_curl_set_option_proxy_ssl_verify_peer));
  lcl_ns_def(curl_ns, "set_proxy_ssl_verify_host", lcl_c_proc_new("curl::set_proxy_ssl_verify_host", c_curl_set_option_proxy_ssl_verify_host));
  lcl_ns_def(curl_ns, "set_proxy_ca_info",         lcl_c_proc_new("curl::set_proxy_ca_info", c_curl_set_option_proxy_ca_info));
  lcl_ns_def(curl_ns, "set_proxy_ca_path",         lcl_c_proc_new("curl::set_proxy_ca_path", c_curl_set_option_proxy_ca_path));
  lcl_ns_def(curl_ns, "set_proxy_ssl_version",     lcl_c_proc_new("curl::set_proxy_ssl_version", c_curl_set_option_proxy_ssl_version));

  /* DNS and connection reuse */
  lcl_ns_def(curl_ns, "set_doh_url",       lcl_c_proc_new("curl::set_doh_url", c_curl_set_option_doh_url));
  lcl_ns_def(curl_ns, "set_dns_servers",   lcl_c_proc_new("curl::set_dns_servers", c_curl_set_option_dns_servers));
  lcl_ns_def(curl_ns, "set_fresh_connect", lcl_c_proc_new("curl::set_fresh_connect", c_curl_set_option_fresh_connect));
  lcl_ns_def(curl_ns, "set_forbid_reuse",  lcl_c_proc_new("curl::set_forbid_reuse", c_curl_set_option_forbid_reuse));

  /* Speed limits */
  lcl_ns_def(curl_ns, "set_max_recv_speed", lcl_c_proc_new("curl::set_max_recv_speed", c_curl_set_option_max_recv_speed_large));
  lcl_ns_def(curl_ns, "set_max_send_speed", lcl_c_proc_new("curl::set_max_send_speed", c_curl_set_option_max_send_speed_large));

  /* Cookies */
  lcl_ns_def(curl_ns, "set_cookie_file", lcl_c_proc_new("curl::set_cookie_file", c_curl_set_option_cookie_file));
  lcl_ns_def(curl_ns, "set_cookie_jar",  lcl_c_proc_new("curl::set_cookie_jar", c_curl_set_option_cookie_jar));

  /* Observability */
  lcl_ns_def(curl_ns, "set_verbose",        lcl_c_proc_new("curl::set_verbose", c_curl_set_option_verbose));
  lcl_ns_def(curl_ns, "set_include_header", lcl_c_proc_new("curl::set_include_header", c_curl_set_option_header));
  ...
  lcl_ns_def(curl_ns, "get_response_code", lcl_c_proc_new("curl::get_response_code", c_curl_get_info_response_code));
  lcl_ns_def(curl_ns, "get_content_type",  lcl_c_proc_new("curl::get_content_type", c_curl_get_info_content_type));
  lcl_ns_def(curl_ns, "get_effective_url", lcl_c_proc_new("curl::get_effective_url", c_curl_get_info_effective_url));
  lcl_ns_def(curl_ns, "get_total_time",    lcl_c_proc_new("curl::get_total_time", c_curl_get_info_total_time));
  lcl_ns_def(curl_ns, "get_header_size",   lcl_c_proc_new("curl::get_header_size", c_curl_get_info_header_size));
  lcl_ns_def(curl_ns, "get_request_size",  lcl_c_proc_new("curl::get_request_size", c_curl_get_info_request_size));
  lcl_ns_def(curl_ns, "get_num_connects",  lcl_c_proc_new("curl::get_num_connects", c_curl_get_info_num_connects));
  lcl_ns_def(curl_ns, "get_primary_ip",    lcl_c_proc_new("curl::get_primary_ip", c_curl_get_info_primary_ip));
  lcl_ns_def(curl_ns, "get_primary_port",  lcl_c_proc_new("curl::get_primary_port", c_curl_get_info_primary_port));
}
